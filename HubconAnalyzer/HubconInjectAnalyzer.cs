...
#pragma warning disable RS2008 // Habilitar el seguimiento de versiones del analizador
                DiagnosticId,
#pragma warning restore RS2008 // Habilitar el seguimiento de versiones del analizador
            ...
            private static void AnalyzeProperty(SyntaxNodeAnalysisContext context)
            {
                ...
                var hasInject = property.AttributeLists
                    ...
                    .Any(attr => attr.Name.ToString().Contains("HubconInject"));
