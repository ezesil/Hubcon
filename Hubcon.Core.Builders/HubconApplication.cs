...
namespace Hubcon.Core.Builders
{
    public class HubconApplication : IHubconClientApplication
    {
        ...
        Task<IHubconClientController<ICommunicationHandler>> IHubconClientApplication.StartInstanceAsync(string? url, Action<string>? consoleOutput, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }
