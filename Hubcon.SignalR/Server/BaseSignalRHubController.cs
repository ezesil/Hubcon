...
namespace Hubcon.SignalR.Server
{
    ...
    //    public async Task<IOperationResponse<JsonElement>> HandleMethodTask(OperationRequest info) 
    //        => await HubconController.Pipeline.HandleWithResultAsync(info);
    //    public async Task<IResponse> HandleMethodVoid(OperationRequest info) 
    ...
    //    public IAsyncEnumerable<JsonElement> HandleMethodStream(OperationRequest info) 
